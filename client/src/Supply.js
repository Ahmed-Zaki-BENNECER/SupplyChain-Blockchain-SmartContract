...
function Supply() {
  ...
  const loadBlockchaindata = async () => {
    ...
    if (networkData) {
      ...
      const medStage = [];
      for (i = 0; i < medCtr; i++) {
        med[i] = await supplychain.methods.GoodStock(i + 1).call();
  ...
  return (
    <div>
      ...
      <h6>
        <b>Supply Chain Process:</b>
      </h6>
      <p>
        Good Order -&gt; Raw Material Supplier -&gt; Manufacturer -&gt;
      ...
      <br />
      <h5>
        <b>Step 4: Mark as sold</b>(Only a registered Customer can perform this
        step):-
      </h5>
